...
public class VoxelWorld_TestMap_Landscape extends SceneBase {

	public static class Factory implements Function1<Scene, Double> {

		@GadgetDouble(p = -.5, q = 0.5) double rotateX = 0;
		@GadgetDouble(p = -.5, q = 0.5) double rotateY = 0;
		@GadgetDouble(p = -.5, q = 0.5) double rotateZ = 0;
		...
		@GadgetDouble(p = 0, q = 5.0) double scale = 1. / 64;
		...
		@Override public Scene at(Double time) {
			try {
				return new VoxelWorld_TestMap_Landscape(
						seed, cameraAngle,
	...
	public VoxelWorld_TestMap_Landscape(
		...
		String path = "img//ares-vallis-raised-1536x1024.jpg";
