...
public class VoxelWorld_TestMap_Small extends SceneBase {
	...
	public static class Factory implements Function1<Scene, Double> {
		...
		@GadgetDouble(p = 0, q = 5.0) double scale = 1.5 / 256;
		...
		@Override public Scene at(Double time) {
			try {
				return new VoxelWorld_TestMap_Small(
						seed, cameraAngle,
	...
	public VoxelWorld_TestMap_Small(
		...
		String path = "img//ares-vallis_128.jpg";
