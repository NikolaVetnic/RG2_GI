...
import graphics3d.solids.voxelworld.f.FTerrain;
import mars.drawingx.gadgets.annotations.GadgetDouble;
import mars.drawingx.gadgets.annotations.GadgetInteger;
import mars.functions.interfaces.Function1;
import mars.utils.Numeric;

public class VoxelWorld_TestFTerrain extends SceneBase {
	...
	public static class Factory implements Function1<Scene, Double> {
		...
		@Override public Scene at(Double time) {
			try {
				return new VoxelWorld_TestFTerrain(
						seed, cameraAngle,
	...
	public VoxelWorld_TestFTerrain(
		...
		int len = 128;
		Vec3 dim = Vec3.xyz(len, len, 32);
		
//		FTerrain vo = FTerrain.newTerrain(dim, TerrainPalette.PASTORAL, true);
//		FTerrain vo = FTerrain.newTerrain(dim, TerrainPalette.ARCTIC, true);
		FTerrain vo = FTerrain.newTerrain(dim, TerrainPalette.DUNE, false);
//		FTerrain vo = FTerrain.newTerrain(dim, TerrainPalette.MARS, false);
