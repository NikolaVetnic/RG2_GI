...
public class FGridMarch2O extends BaseF {
	...
	protected FGridMarch2O(Vec3 d, Predicate<Vec3> p, Function<Vec3, Color> c) { super(d, p, c); }


	public static FGridMarch2O d(Vec3 d, Predicate<Vec3> p, Function<Vec3, Color> c) 	{
		return new FGridMarch2O(d, p, c);
	}


	public static FGridMarch2O xyz(int x, int y, int z, Predicate<Vec3> p, Function<Vec3, Color> c) {
		return new FGridMarch2O(Vec3.xyz(x, y, z), p, c);
	}
