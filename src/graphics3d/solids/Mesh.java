...
//			hits.sort((h1, h2) -> h1.t() - h2.t() > 0 ? 1 : h1.t() - h2.t() == 0 ? 0 : -1);
	...
	private boolean isPointOnPlane(Vec3 p, Vec3[] triangle) {
		...
		// Naravno, vektorski mo�e� re�iti lako
		// uzme� vektor AP i uradi� skalarni proizvod sa vektorom AB x AC
		// To je proporcionalno du�ini projekcije AP na normalu na ravan
